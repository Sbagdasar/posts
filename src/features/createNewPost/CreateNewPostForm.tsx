...
type CreateNewPostFormPropsType = { addNewPost: (post: { title: string; body: string }) => void }
export const CreateNewPostForm = ({ addNewPost }: CreateNewPostFormPropsType) => {
  ...
  return (
    <Form className={s.customForm} name="basic" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
